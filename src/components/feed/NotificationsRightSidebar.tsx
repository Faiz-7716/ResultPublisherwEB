  ...
  return (
    <aside className={`flex flex-col gap-6 w-full pb-6 pt-5 ${className}`}>
      ...
      <div className="bg-background rounded-2xl border border-muted shadow-sm overflow-hidden flex flex-col">
        ...
        {/* Section 2: Weekly Growth (Sparkline) */}
        <div className="p-4 border-b border-muted bg-gradient-to-br from-primary/[0.03] to-background">
          <div className="flex items-center justify-between mb-2">
            <h3 className="text-xs font-black text-muted-foreground uppercase tracking-widest">This Week</h3>
            <span className="text-[10px] font-bold bg-emerald-500/10 text-emerald-600 px-2 py-0.5 rounded-full">+12%</span>
          </div>
          <div className="flex items-end gap-3 mb-3">
            <div className="flex-1">
              <span className="text-sm font-bold text-foreground block">+42 Followers</span>
              <span className="text-sm font-bold text-foreground block">+128 Likes</span>
            </div>
            {/* Sparkline SVG Mock */}
            <div className="w-[80px] h-[30px] shrink-0 text-primary">
              <svg viewBox="0 0 100 30" className="w-full h-full overflow-visible" preserveAspectRatio="none">
                 <path d="M0 25 L10 22 L20 28 L30 15 L40 18 L50 10 L60 12 L70 5 L80 8 L90 2 L100 0" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
