        ...
        <div className="absolute top-0 left-0 h-full w-[88px] hover:w-64 bg-background transition-all duration-300 ease-in-out overflow-y-auto overflow-x-hidden hide-scrollbar flex flex-col group hover:shadow-2xl border-r border-transparent hover:border-muted z-50 rounded-r-2xl pb-6">
              ...
              return (
                ...
                >
                  <div className="flex items-center w-full">
                    ...
                    <span className="whitespace-nowrap ml-3 text-[16px] tracking-wide opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                      {link.label}
                    </span>
                  </div>
          ...
          <div className="px-3 mt-4">
            ...
            >
              ...
              <span className="whitespace-nowrap text-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                Post Update
              </span>
            </button>
          </div>
          ...
          <div className="mt-auto px-3">
            <div className="h-[64px] bg-muted/20 border border-muted rounded-2xl flex items-center cursor-pointer hover:bg-muted/60 transition-all duration-300 hover:shadow-sm overflow-hidden">
              ...
              <div className="flex-1 flex items-center justify-between opacity-0 group-hover:opacity-100 transition-opacity duration-300 pr-4 whitespace-nowrap">
