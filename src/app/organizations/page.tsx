    ...
    <div ref={containerRef} className="min-h-screen bg-[#FAFAFA] text-zinc-900 font-sans selection:bg-primary/20">
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden flex items-center justify-center min-h-[95vh]">
        ...
        <div className="max-w-[1200px] mx-auto px-6 relative z-20 flex flex-col items-center text-center">
          ...
          <motion.h1 
            ...
            className="text-6xl md:text-7xl lg:text-[92px] font-extrabold tracking-tight leading-[1.05] text-zinc-950 max-w-5xl"
          >
          ...
          >
             <Link href="/organizations/login" className="w-full sm:w-auto px-8 py-4 bg-zinc-900 text-white rounded-2xl font-bold text-lg shadow-[0_8px_30px_rgb(0,0,0,0.12)] hover:scale-105 active:scale-95 transition-transform flex items-center justify-center gap-2">
               Organization Login
               <ArrowUpRight size={18}/>
             </Link>
             <Link href="/explore" className="w-full sm:w-auto px-8 py-4 bg-white border border-black/10 text-zinc-900 rounded-2xl font-bold text-lg shadow-sm hover:bg-zinc-50 active:scale-95 transition-all flex items-center justify-center gap-2">
               Explore Platform
             </Link>
          </motion.div>
          ...
          <motion.div 
            ...
            className="mt-24 relative w-full max-w-6xl aspect-[21/9] border border-white/50 bg-white/40 backdrop-blur-3xl rounded-[40px] shadow-2xl p-8 overflow-hidden flex items-center justify-center"
          >
             {/* Ecosystem Map Animated Lines */}
             ...
             {/* Floating Nodes */}
             <div className="relative flex flex-wrap gap-6 items-center justify-center z-10 w-full h-full">
                
                <motion.div animate={{ y: [0, -15, 0] }} transition={{ duration: 5, repeat: Infinity, ease: "easeInOut" }} className="absolute top-[20%] left-[10%] w-52 bg-white/90 backdrop-blur-md p-5 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] border border-black/5 flex items-center gap-4">
                  <div className="w-12 h-12 bg-indigo-100 text-indigo-600 rounded-xl flex items-center justify-center"><Building2 size={24}/></div>
                ...
                <motion.div animate={{ y: [0, 15, 0] }} transition={{ duration: 6, repeat: Infinity, ease: "easeInOut", delay: 1 }} className="absolute bottom-[20%] left-[30%] w-52 bg-white/90 backdrop-blur-md p-5 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] border border-black/5 flex items-center gap-4">
                  <div className="w-12 h-12 bg-emerald-100 text-emerald-600 rounded-xl flex items-center justify-center"><Database size={24}/></div>
                ...
                <motion.div animate={{ y: [0, -10, 0] }} transition={{ duration: 4.5, repeat: Infinity, ease: "easeInOut", delay: 0.5 }} className="absolute top-[30%] right-[30%] w-52 bg-white/90 backdrop-blur-md p-5 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] border border-black/5 flex items-center gap-4">
                ...
                <motion.div animate={{ y: [0, 20, 0] }} transition={{ duration: 5.5, repeat: Infinity, ease: "easeInOut", delay: 1.5 }} className="absolute bottom-[30%] right-[10%] w-52 bg-white/90 backdrop-blur-md p-5 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] border border-black/5 flex items-center gap-4">
                  <div className="w-12 h-12 bg-pink-100 text-pink-600 rounded-xl flex items-center justify-center"><BarChart3 size={24}/></div>
      ...
      <section className="py-40 bg-[#FAFAFA] border-t border-black/5 overflow-hidden relative">
        ...
        <div className="max-w-[800px] mx-auto px-6 text-center relative z-10">
          <h2 className="text-5xl md:text-7xl font-extrabold tracking-tight mb-8 text-zinc-900 leading-tight">
            Ready to modernize your organization?
          </h2>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-12">
             <Link href="/organizations/login" className="w-full sm:w-auto px-10 py-5 bg-zinc-900 text-white rounded-2xl font-bold text-lg shadow-[0_8px_30px_rgb(0,0,0,0.15)] hover:shadow-[0_10px_40px_rgb(0,0,0,0.25)] hover:-translate-y-1 active:scale-95 transition-all flex items-center justify-center gap-2">
