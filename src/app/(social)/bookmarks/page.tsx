...
const MOCK_ITEMS: SavedItem[] = [
  { id: "1", type: "result", title: "Statewide High School Board Results 2026", organization: "Department of Education", category: "Education", date: "2 hours ago", timeGroup: "Today", tags: ["Verified", "Final"], isOffline: true },
  { id: "2", type: "document", title: "Q3 Fiscal Policy Guidelines & Taxation Updates", organization: "Ministry of Finance", category: "Finance", date: "5 hours ago", timeGroup: "Today", tags: ["PDF", "Draft"] },
  { id: "3", type: "poll", title: "Public Opinion: Upcoming City Infrastructure Budget", organization: "City Council", category: "Government", date: "Yesterday", timeGroup: "Yesterday", tags: ["Active Poll"] },
  { id: "4", type: "result", title: "National Athletics Championship Finals", organization: "Sports Federation", category: "Sports", date: "Yesterday", timeGroup: "Yesterday", tags: ["Live"] },
  { id: "5", type: "discussion", title: "Impact of AI on modern healthcare privacy", organization: "Health Tech Forum", category: "Healthcare", date: "3 days ago", timeGroup: "This Week", tags: ["Trending", "Discussion"] },
  { id: "6", type: "document", title: "Supreme Court Ruling 405.b (Digital Privacy)", organization: "Supreme Court", category: "Law", date: "Last week", timeGroup: "Earlier", tags: ["Verified", "Legal"], isOffline: true },
];
        ...
        <div className="space-y-12">
          ...
          {filteredItems.length === 0 && (
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="flex flex-col items-center justify-center py-32 text-center">
               ...
               <Link href="/explore" className="px-6 py-3 bg-zinc-900 text-white font-bold rounded-xl hover:-translate-y-0.5 hover:shadow-lg transition-all">
                 Explore ResultHub
               </Link>
            </motion.div>
          )}
